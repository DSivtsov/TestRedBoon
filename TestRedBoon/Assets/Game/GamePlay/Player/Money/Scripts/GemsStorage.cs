...
namespace Game.Gameplay.Player
{
    ...
    public sealed class GemsStorage
    {
        ...
        public GemsStorage(int money)
        {
            Debug.Log($"MoneyStorage.ctor({money})");
            this._gems = money;
        }
        ...
        public bool CanSpendMoney(int amount) => this._gems >= amount;
    }
}